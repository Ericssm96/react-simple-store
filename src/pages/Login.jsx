import { FormInputNoLabel, Button } from "../components";
    ...
    <section className="flex h-screen items-center justify-center">
      <div className="form-container bg-purple-100 rounded-xl w-screen max-w-[420px] p-10 flex flex-col gap-y-4 shadow-lg">
        ...
        <form className="flex flex-col gap-y-4">
          ...
          <Button type="submit" colorClass="btn-primary" text="Login" />
          <Button type="button" colorClass="btn-secondary" text="Guest User" />
        </form>
